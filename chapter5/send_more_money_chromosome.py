...
class SendMoreMoneyChromosome(Chromosome):
    ...
    @classmethod
    def random_instance(cls) -> SendMoreMoneyChromosome:
        letters = ["S", "E", "N", "D", "M", "O", "R", "Y", " ", " "]
        shuffle(letters) 
        return SendMoreMoneyChromosome(letters)

    
    def crossover(self, other: SendMoreMoneyChromosome) -> Tuple[SendMoreMoneyChromosome, SendMoreMoneyChromosome]:
        
        child1: SendMoreMoneyChromosome = deepcopy(self)
        child2: SendMoreMoneyChromosome = deepcopy(other)
...
if __name__ == "__main__":
    ...
    initial_population: List[SendMoreMoneyChromosome] = [SendMoreMoneyChromosome.random_instance() for _ in range(1000)]
    ga: GeneticAlgorithm[SendMoreMoneyChromosome] = GeneticAlgorithm(
    ...
    result: SendMoreMoneyChromosome = ga.run()
    print(result)